...
public class MenuParaFigurasConCase {
	...
	public static void main(String[] args) {
		...
		switch (figura){//Usamos switch para los cuatro.. no es necesario el default:
		...
		case 2:
			...
			//EL PROBLEMA SURGE CON EL p1 QUE ESTA ENCAPSULADO EN EL PRIMER CASE, LO INTENTO CON 
			//LOS CONSTRUCTORES DE PUNTOS Y PARAMETROS INTENTANDO CLONAR EL p1 EN p3 Y NO LO CONSIGO
			
			double j=p1.getx();
			double k=p1.gety();
			Punto p3= new Punto(j,k);
			System.out.println("Distancia del primer punto al centro del círculo: "+p.calcularDistanciaPunto(c.getCentro()));
		...
		teclado.close();//cerramos objeto teclado
		
		
	}//cierra main
	public static void clonarPunto (Punto p){
